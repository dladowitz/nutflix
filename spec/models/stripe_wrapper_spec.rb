...
#
#   context "with a valid card"
#
#   context "with an invalid card number"
# end
...
describe StripeWrapper::Charge, "#create" do
  ...
  context "with a valid card" do
    it "should return :success in it's status" do
...
describe StripeWrapper::Token, "#create" do
  ...
  context "with an invalid expiration date" do
    ...
    it "has a message" do
      expect(subject.status_message).to be "Expired Card"
    end
  end
end
